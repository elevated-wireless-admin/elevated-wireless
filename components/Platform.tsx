...
const ROWS: Row[] = [
  {
    ...
    body: "Connectivity via our MVNO partnership with Reach Mobile. SIM provisioning, device activation, billing, customer support, regulatory compliance, carrier reporting — all handled.",
    bullets: [
      "Verizon 5G nationwide (same network, different experience)",
      "MVNO operations end-to-end via Reach Mobile",
